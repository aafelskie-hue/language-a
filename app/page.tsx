  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(to bottom, #0f1f33 0%, #0f1f33 45%, #3d2e1e 70%, #f2ece4 100%)' }}
      >
      ...
      <section className="bg-surface-warm border-b border-slate/10">
        <div className="max-w-page mx-auto px-4 md:px-6 py-12 md:py-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Neighborhood */}
            <Link
              href="/patterns?scale=neighborhood"
            ...
            {/* Construction */}
            <Link
              href="/patterns?scale=construction"
              className="card card-hover text-left group"
            >
